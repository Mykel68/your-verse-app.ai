      ...
      <div className="relative h-full flex flex-col justify-end p-8 transition-all duration-500 group-hover:p-10">
        {verse ? (
          <div className="text-center space-y-6 animate-fade-in">
            ...
            {isHovered && (
              <>
                <div className="absolute top-1/4 left-1/4 w-1 h-1 bg-white/60 rounded-full animate-float" style={{ animationDelay: '0s' }} />
                <div className="absolute top-1/3 right-1/3 w-1.5 h-1.5 bg-accent/60 rounded-full animate-float" style={{ animationDelay: '0.5s' }} />
                <div className="absolute bottom-1/2 left-1/5 w-1 h-1 bg-white/40 rounded-full animate-float" style={{ animationDelay: '1s' }} />
              </>
            )}
          </div>
        ) : (
